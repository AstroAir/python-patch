...
from patch.application import (
    diffstat, findfile, can_patch, match_file_hunks,
...
class TestApplicationIntegration:
    ...
    def test_full_patch_application_workflow(self, temp_dir, sample_patch_content, sample_file_content, expected_patched_content):
    ...
    def test_patch_revert_workflow(self, temp_dir, sample_patch_content, sample_file_content, expected_patched_content):
