...
from patch.application import findfile, match_file_hunks, patch_stream
...
class TestCLIEdgeCases:
    ...
    def test_cli_with_unusual_arguments(self):
        ...
        with mock_patch.object(
            sys, "argv", ["patch", "--strip", "invalid", "file.patch"]
        ):
            with pytest.raises(SystemExit):
                main()
...
@pytest.mark.parametrize(
    "input_path,strip_level,expected",
    [
