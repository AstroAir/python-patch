...
class TestDetectType:
    ...
    def test_detect_type_hg_patch_plain_style(self):
        ...
        patch_obj.target = b'b/file.txt'
        patch_obj.header = [
            b'diff -r 1234567890ab file.txt\n'
        ]
...
@pytest.mark.parametrize("patch_type,source_prefix,target_prefix", [
    (patch.GIT, b'a/', b'b/'),
    (patch.HG, b'a/', b'b/'),
    (patch.PLAIN, b'', b''),
])
def test_type_detection_and_normalization_parametrized(patch_type, source_prefix, target_prefix):
