...
class EVENT_LOOP(unittest.TestCase):
    def t_scheduled(self, interval, iterations, sleep_time=0):
        print(
            "Test interval=%s, iterations=%s, sleep=%s"
            % (interval, iterations, sleep_time)
        )
    ...
    def test_d1_50(self):
        self.t_scheduled(0.1, 50)

    def test_d1_50_d05(self):
        self.t_scheduled(0.1, 50, 0.05)

    def test_d05_50(self):
        self.t_scheduled(0.05, 50)

    def test_d05_50_d03(self):
        self.t_scheduled(0.05, 50, 0.03)

    def test_d02_50(self):
        self.t_scheduled(0.02, 50)

    def test_d01_50(self):
        self.t_scheduled(0.01, 50)
